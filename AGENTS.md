...
Run focused checks while iterating and all applicable checks before handoff. Never claim Pi 3B+ acceptance without results from the real release-gating device. Record results from Pi 3B, Pi 4B, and Pi 5 without strengthening compatibility claims beyond their evidence.
