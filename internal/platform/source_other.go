...
func NewSource() ProductionSource { return unsupportedSource{} }
...
func (unsupportedSource) CPUStat() ([]byte, error)              { return nil, fs.ErrNotExist }
func (unsupportedSource) BootID() ([]byte, error)               { return nil, fs.ErrNotExist }
